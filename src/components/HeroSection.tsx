    ...
    <section className="relative min-h-[min(100dvh,920px)] overflow-hidden bg-[#FBFAF7]">
      ...
      <div className="relative z-10 flex min-h-[min(100dvh,920px)] items-center justify-center px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto flex w-full max-w-4xl flex-col items-center text-center">
          ...
          <h1
            className={`${rise} ${STAGGER[1]} font-display mt-6 max-w-[14ch] text-[clamp(2.75rem,6vw,5rem)] font-bold leading-[1.08] tracking-[-0.02em] text-[#1a1a2e] [text-shadow:0_1px_32px_rgba(26,26,46,0.08)]`}
          >
            A{" "}
          ...
          <p
            className={`${rise} ${STAGGER[2]} mt-6 max-w-[32.5rem] text-[1.0625rem] leading-relaxed text-[#4a4a6a] sm:text-lg`}
          >
          ...
          <div
            className={`${rise} ${STAGGER[3]} mt-8 flex w-full max-w-md flex-col items-stretch gap-3 sm:max-w-none sm:flex-row sm:justify-center`}
          >
            <Link
              href="/mathematics"
              className="group relative inline-flex min-h-[3rem] items-center justify-center overflow-hidden rounded-full bg-[#1a1a2e] px-7 py-3 text-[0.9375rem] font-semibold text-white shadow-[0_10px_28px_-12px_rgba(26,26,46,0.55)] transition-[transform,box-shadow] duration-200 hover:-translate-y-0.5 hover:shadow-[0_16px_36px_-14px_rgba(26,26,46,0.5)]"
            >
              <span
                aria-hidden
            ...
            <Link
              href="/book"
              className="inline-flex min-h-[3rem] items-center justify-center rounded-full border-2 border-[#1a1a2e]/25 bg-transparent px-7 py-3 text-[0.9375rem] font-semibold text-[#1a1a2e] transition-[background-color,border-color,transform] duration-200 hover:-translate-y-0.5 hover:border-[#1a1a2e] hover:bg-[#1a1a2e]/[0.05]"
            >
              Book a free 1:1
            </Link>
          </div>
          ...
          <div
            className={`${rise} ${STAGGER[5]} mt-10 grid w-full max-w-3xl grid-cols-2 gap-6 sm:grid-cols-4 sm:gap-0`}
          >
...
function HeroStat({
  ...
  return (
    ...
    >
      <span className="font-display text-2xl font-bold tracking-tight text-[#1a1a2e] sm:text-[1.75rem]">
        {value}
      </span>
