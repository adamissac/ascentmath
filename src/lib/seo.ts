...
export const SEO_HOME_DESCRIPTION =
  "1-on-1 online math tutoring with Adam Issac and Alan Mozhoor (Math + CS @ Georgia Tech). K-5 through college, SAT/ACT, and AP. Free consultation call for new clients, plus free Grades 6-8 study paths. No account needed.";
