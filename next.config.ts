...
const nextConfig: NextConfig = {
  ...
  async headers() {
    return [
      ...
      {
        source:
          "/:file(favicon.ico|favicon-32.png|app-icon.ico|app-icon-32.png|app-icon-180.png|app-icon-512.png|apple-touch-icon.png|apple-touch-icon-180x180.png|ascent-fav.ico|ascent-fav-32.png|ascent-icon-512.png|ascent-apple-180.png|android-chrome-192.png|android-chrome-512.png|android-chrome-maskable-192.png|android-chrome-maskable-512.png|site.webmanifest)",
